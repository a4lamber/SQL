/*
Problem: You want to traverse a string to return each character as a row,
...
Note:
- SQL做string parsing确实比较cumbersome
- Pivot table is helpful
- cardinality: it stands for how many rows in a table for simplicity.
*/
